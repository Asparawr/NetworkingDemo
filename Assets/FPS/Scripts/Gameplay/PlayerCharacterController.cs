...
namespace Unity.FPS.Gameplay
{
    ...
    public partial class PlayerCharacterController : NetworkBehaviour
    {
        ...
        void Start()
        {
            ...
            // Set layer to player for every child
        ...
        void OnDie()
        {
            ...
            NetworkIdentity playerIndentity = GetComponent<NetworkIdentity>();
            RpcRespawn(playerIndentity.connectionToClient);
        }
        ...
        void HandleCharacterMovement()
        {
            ...
            if(m_Controller.enabled) m_Controller.Move(CharacterVelocity * Time.deltaTime);
