...
namespace Unity.FPS.Gameplay
{
    ...
    public partial class PlayerWeaponsManager : NetworkBehaviour
    {
        ...
        void Start()
        {
            ...
            PlayerCameraData playerCameraData = cameraGameObject.GetComponent<PlayerCameraData>();
            WeaponCamera = playerCameraData.WeaponCamera;
                ...
                else
                {
                    ...
                    if (switchWeaponInput != 0)
                    {
                        if (GetWeaponAtSlotIndex(switchWeaponInput - 1) != null)
                            CmdSwitchToWeaponIndex(switchWeaponInput - 1, false);
                    }
                }
            }
        ...
        public void SwitchWeapon(bool ascendingOrder)
        {
            ...
            CmdSwitchToWeaponIndex(newWeaponIndex, false);
        }
        ...
        public void SwitchToWeaponIndex(int newWeaponIndex, bool force = false)
        {
            ...
            for (int i = 0; i < m_WeaponSlots.Length; i++)
            {
                if (i != newWeaponIndex)
                {
                    WeaponController weapon = GetWeaponAtSlotIndex(i);
                    if (weapon != null)
                    {
        ...
        public bool AddWeapon(WeaponController weaponPrefab)
        {
            ...
            for (int i = 0; i < m_WeaponSlots.Length; i++)
            {
                ...
                {
                    // get weapon i from children of socket
                    WeaponController weaponInstance = WeaponParentSocket.GetChild(i).GetComponentInChildren<WeaponController>();
